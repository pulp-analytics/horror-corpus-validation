...
reviewing 06_bedrock_ocr.py's mismatch verdicts against this output (see
...
once checked against what this script fetched).
  ...
  TMDB_API_KEY=... python3 05_fetch_alt_titles.py --in data/sample_output/tmdb_horror_ids.csv
  python3 05_fetch_alt_titles.py --akas /path/to/title.akas.tsv.gz --in ...
